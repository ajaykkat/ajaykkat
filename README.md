...
| --- | --- | --- |
| [xHR / Job Copilot](https://github.com/ajaykkat/job-copilot) | An AI job application assistant with resume tailoring, job-fit scoring, browser automation, and human review. | Python, FastAPI, OpenAI, Playwright |
| [Talent Match](https://github.com/ajaykkat/Talent_Match) | Structured profile extraction, vector retrieval, and LLM reranking with match explanations. | Python, PostgreSQL, pgvector, sentence-transformers |
